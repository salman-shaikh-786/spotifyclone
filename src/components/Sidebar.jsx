...
const navigate= useNavigate();
  ...
  return (
    <div className='hidden lg:flex w-[25%] h-full p-2 flex-col gap-2 text-white'>
      ...
      <div className='bg-[#121212] h-[85%] rounded'>
        ...
        <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4' >
          <h1>Create your fisrt playlist</h1>
          <p className='font-light' >it's easy we will help you</p>
          <button className='px-4 py-1.5 bg-white text-black text-[15px] rounded-full mt-4'>Create play list</button>
        </div>
