...
<img className='w-4' src={assets.clock_icon} alt="" />
     ...
     <hr />
     {
      songsData.map((item,index)=>(
        <div onClick={()=>playWithId(item.id)} key={index} className='grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 m-1 item-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
